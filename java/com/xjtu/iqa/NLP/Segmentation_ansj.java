...
import com.xjtu.iqa.vo.NLP_Word;
import com.xjtu.iqa.vo.robot_Chat;
import com.xjtu.iqa.vo.robot_ChatView;
...
//		Forest forest = Library.makeForest(localurl+"/iqa_fore/library/computer.dic");
	...
	public List<robot_ChatView> similarScoreSecond1() throws Exception{
		...
		Forest forest = Library.makeForest(tomcatPath+"/iqa_fore/library/computer.dic");
