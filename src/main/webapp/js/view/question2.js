...
function replyQuestion(){
	...
	if(content==""){
		...
		$.ajax({
			type:"POST",
			url:base+"/saveReplyQuestion.html",
			data:{
				"content":content,
...
function saveComment(){
	...
	if(id==""){
		if(content==""){
			...
			$.ajax({
				type:"POST",
				url:base+"/saveCommunityComment.html",
				data:{
					"questionId":questionId,
					"content":content,
					"answerId":answerId
		...
		if(content==""){
			...
			$.ajax({
				type:"POST",
				url:base+"/saveCommunityReply.html",
				data:{
					"questionId":questionId,
					"content":content,
					"answerId":answerId,
...
function getCollectionAnswer(){
	...
	if(answerId!="searchResult"){
		$.ajax({
			type:"POST",
			url:base+"/saveCollectionAnswer.html",
			data:{
				"answerId":answerId
			},
			dataType:"json",
...
$.ajax({
	type:"POST",
	url:base+"/queryMoreComment2.html",
	data:{
