				...
				if(data.faqView==""){
					...
					for(var i in data.faqView){
						if(document.getElementById("zhao2_article-main").getElementsByClassName("articles-list")[0]==null){
							document.getElementById("zhao2_article-main").innerHTML='<div  class="article-main"><div  class="articles-list"></div></div>';
						}
						if(document.getElementById("myfaq"+data.faqView[i].faqId)==null){
							...
							document.getElementById("zhao2_article-main").getElementsByClassName("articles-list")[0].innerHTML=html + 
							' <div class="list-item article-item" id="myfaq'+data.faqView[i].faqId+'"> '
							+'<h3 class="item-title"> '
							+'<a target="_blank" href="faq3.html?q='+data.faqView[i].faqId+'" class="title-detail">'+data.faqView[i].title+'</a>'
							+'</h3> '
							+'<div class="zhao"> '+data.faqView[i].content+'</div> '
							+'<div class="item-btm clearfix"> '
							+'<ul class="l left-info"> '
							+'<li class="hd-pic"> <a class="publisher-name" href="personal2.html?u='+data.faqView[i].userId+'" target="_blank">'+data.faqView[i].username+'</a> </li> '
							+'</ul> '
							+'<div class="r right-info"> '
							+'<div class="favorite l"> <i class="icon sns-thumb-up-outline"></i><em> '+data.faqView[i].scanNumber+'浏览</em> </div> '
							+'<div class="favorite l"> <i class="icon sns-thumb-up-outline"></i><em> '+data.faqView[i].collectionNumber+'收藏</em> </div> '
							+'<div class=" l"> <i class="icon sns-comment"></i><em> '+data.faqView[0].commentNumber+'评论</em> </div> '
							+'</div> '
							+'</div>'
							+'</div> ';
						}
			...
			if(data.value=="0"){
				...
				if(data.communityView==""){
					...
					for(var i in data.communityView){
						...
						if(document.getElementById("payCommunity"+data.communityView[i].questionId+i)==null){
							var html = document.getElementById("zhao3_article-main2").getElementsByClassName("ques-list")[0].innerHTML;
							document.getElementById("zhao3_article-main2").getElementsByClassName("ques-list")[0].innerHTML=html + 
							'<div class="ques-answer" id="payCommunity'+data.communityView[i].questionId+'"> '
							+'<div class="tag-img"> '
							+'<a href="question.html?c='+data.communityView[i].classifyName+'&type=all" target="_blank">'
							+'<img src="'+data.communityView[i].classifyImage+'"> '
							+'</a> '
							+'</div> '
							+'<div class="from-tag">来自<a href="question.html?c='+data.communityView[i].classifyName+'&type=all" target="_blank">'+data.communityView[i].classifyName+'</a></div> '
							+'<div class="ques-con"> <a href="question2.html?q='+data.communityView[i].questionId+'" class="ques-con-content"  target="_blank">'+data.communityView[i].title+'</a> </div>'
							+'<div class="answer-con" > '
							+'<div class="user">关注答案</div> '
							+'<div class="answer-content"> '
							+'<a href="question2.html?q='+data.communityView[i].questionId+'" target="_blank">'+data.communityView[i].content+'</a> '
							+'</div> '
							+'</div> '
							+'<div class="about-info"> '
							+'<span class="time">'+data.communityView[i].replyTime.substring(0,16)+'</span> '
							+'<a href="question2.html?q='+data.communityView[i].questionId+'" target="_blank" class="reply-num">'+data.communityView[i].replyNumber+'个回复</a> '
							+'</div> '
							+'</div> ';
						}
					}
					if(data.communityView[0].isMore=="1"){
						var html = document.getElementById("zhao3_article-main2").getElementsByClassName("ques-list")[0].innerHTML;
						document.getElementById("zhao3_article-main2").getElementsByClassName("ques-list")[0].innerHTML=html+
						'<p class="js-noreload dynamicLoad js-dynamicLoadwrap" id="getMorePayCommunity"> '
						+'<span class="js-dynamicLoad " onclick="getMorePayCommunity()">点击显示更多</span> '
						+'</p>';
					}
				}
			}
		...
		success:function(data){
			if(data.value=="0"){
				...
				for(var i in data.communityView){
					...
					if(document.getElementById("payCommunity"+data.communityView[i].questionId+i)==null){
						var html = document.getElementById("zhao3_article-main2").getElementsByClassName("ques-list")[0].innerHTML;
						document.getElementById("zhao3_article-main2").getElementsByClassName("ques-list")[0].innerHTML=html + '<div class="ques-answer" id="payCommunity'+data.communityView[i].questionId+'"> <div class="tag-img"> <a href="question.html?c='+data.communityView[i].classifyName+'&type=all" target="_blank"> <img src="'+data.communityView[i].classifyImage+'"> </a> </div> <div class="from-tag">来自<a href="question.html?c='+data.communityView[i].classifyName+'&type=all" target="_blank">'+data.communityView[i].classifyName+'</a></div> <div class="ques-con"> <a href="question2.html?q='+data.communityView[i].questionId+'" class="ques-con-content"  target="_blank">'+data.communityView[i].title+'</a> </div><div class="answer-con" > <div class="user">关注答案</div> <div class="answer-content"> <a href="question2.html?q='+data.communityView[i].questionId+'" target="_blank">'+data.communityView[i].content+'</a> </div> </div> <div class="about-info"> <span class="time">'+data.communityView[i].replyTime.substring(0,16)+'</span> <a href="question2.html?q='+data.communityView[i].questionId+'" target="_blank" class="reply-num">'+data.communityView[i].replyNumber+'个回复</a> </div> </div> ';
					}
				}
				if(data.communityView[0].isMore=="1"){
					var html = document.getElementById("zhao3_article-main2").getElementsByClassName("ques-list")[0].innerHTML;
			...
			if(data.value=="0"){
				...
				if(data.communityView==""){
					...
					for(var i in data.communityView){
						...
						if(document.getElementById("replyCommunity"+data.communityView[i].questionId+i)==null){
					...
					if(data.communityView[0].isMore=="1"){
						var html = document.getElementById("zhao3_article-main3").getElementsByClassName("ques-list")[0].innerHTML;
						document.getElementById("zhao3_article-main3").getElementsByClassName("ques-list")[0].innerHTML=html+'<p class="js-noreload dynamicLoad js-dynamicLoadwrap" id="getMoreReplyCommunity"> <span class="js-dynamicLoad " onclick="getMoreReplyCommunity()">点击显示更多</span> </p>';
					}
				}
			}
		}
...
//我的回答_下拉显示更多
function getMoreReplyCommunity(){
		...
		success:function(data){
			if(data.value=="0"){
				...
				if(data.communityView==""){
					...
					if(document.getElementById("getMoreReplyCommunity")!=null){
						document.getElementById("getMoreReplyCommunity").remove();
					}
					for(var i in data.communityView){
						if(document.getElementById("zhao3_article-main3").getElementsByClassName("ques-list")[0]==null){
							document.getElementById("zhao3_article-main3").innerHTML='<div class="ques-list"></div>';
						...
						if(document.getElementById("bepay"+data.bepayView[i].userId)==null){
							...
							if(data.bepayView[i].work==null){
								if(data.bepayView[i].isTogetherPay=="1"){
									...
									document.getElementById("zhao4").getElementsByClassName("investment_con_list")[0].getElementsByClassName("concern-list")[0].getElementsByTagName("ul")[0].innerHTML = html + '<li class="box" id="bepay'+data.bepayView[i].userId+'"><div class="left-img"><a href="personal2.html?u='+data.bepayView[i].userId+'" target="_blank"><img src="'+data.bepayView[i].userImage+'" class="top_head"></a></div><div class="right-c"><div class="title"><a href="personal2.html?u='+data.bepayView[i].userId+'" target="_blank"><span class="nickname">'+data.bepayView[i].userName+'</span></a></div><p class="desc"></p><div class="fs-line"><a class="u-target"><span class="group"><em>关注</em><em class="u-margin-l-5">'+data.bepayView[0].payNumber+'</em></span></a><a class="u-target u-margin-l-15"><span class="group"><em>粉丝</em><em class="u-margin-l-5">'+data.bepayView[i].bepayNumber+'</em></span></a></div><div class="btn-line" ><a href="Javascript:" class="btn-o btn-gray-o  js-concern-already">已关注</a></div></div></li>';
								}
							}else{
								if(data.bepayView[i].isTogetherPay=="1"){
									...
									document.getElementById("zhao4").getElementsByClassName("investment_con_list")[0].getElementsByClassName("concern-list")[0].getElementsByTagName("ul")[0].innerHTML = html + '<li class="box" id="bepay'+data.bepayView[i].userId+'"><div class="left-img"><a href="personal2.html?u='+data.bepayView[i].userId+'" target="_blank"><img src="'+data.bepayView[i].userImage+'" class="top_head"></a></div><div class="right-c"><div class="title"><a href="personal2.html?u='+data.bepayView[i].userId+'" target="_blank"><span class="nickname">'+data.bepayView[i].userName+'</span></a><ul class="icon-list"><li class="u-icon imooc-teacher"></li></ul></div><p class="desc">'+data.bepayView[i].work+'</p><div class="fs-line"><a class="u-target"><span class="group"><em>关注</em><em class="u-margin-l-5">'+data.bepayView[0].payNumber+'</em></span></a><a class="u-target u-margin-l-15"><span class="group"><em>粉丝</em><em class="u-margin-l-5">'+data.bepayView[i].bepayNumber+'</em></span></a></div><div class="btn-line" ><a href="Javascript:" class="btn-o btn-gray-o  js-concern-already">已关注</a></div></div></li>';
								}
							}
						}
					}
...
$(document).ready(function(){
	var isMy = document.getElementById("lookOther").innerHTML
	var paylist = document.getElementById("lookOtherPayList").innerHTML
	if(isMy=="0"){
		if(paylist=="0"){
